  ...
  const JOS = new (class {
    ...
    debugger(t = 0) {
      if (0 === t && this.debugMode) {
        this.version();
        let t = {};
        for (let s of Object.keys(this))
          "function" != typeof this[s] && (t[s] = this[s]);
      }
    }
      ...
      document
        ...
        .forEach((t) => {
          ...
          if (e.isIntersecting) {
            ...
            (void 0 === t.dataset.jos_scrolldirection ||
              "down" === t.dataset.jos_scrolldirection ||
              "none" === t.dataset.jos_scrolldirection) &&
              (t.classList.add("jos-" + a),
              void 0 !== t.dataset.jos_invoke_out &&
    ...
    callbackRouter = (t, s, e = 1) => {
      ...
      if (((n = a.boundingClientRect.top < 0 ? 0 : 1), a.isIntersecting)) {
        if (
          ("false" != o.dataset.jos_scroll &&
            null != o.dataset.jos_scroll &&
            (this.scrollEnter.push(o), this.callbackScroller(this.scrollEnter)),
          null != o.dataset.jos_counter)
        ) {
        ...
        (void 0 === o.dataset.jos_scrolldirection ||
          (1 === n && "down" === o.dataset.jos_scrolldirection) ||
          (0 === n && "up" === o.dataset.jos_scrolldirection) ||
          "none" === o.dataset.jos_scrolldirection) &&
          (o.classList.toggle("jos-no-mirror", "false" == o.dataset.jos_mirror),
          o.classList.add("jos-" + i),
          null != r && o.classList.remove("jos-" + r),
          void 0 !== o.dataset.jos_invoke_out &&
            window[o.dataset.jos_invoke_out](o)),
          "false" != o.dataset.jos_scroll &&
            null != o.dataset.jos_scroll &&
            ((this.scrollEnter = this.scrollEnter.filter((t) => t.id !== o.id)),
    ...
    animationInit() {
      let t = [],
        s = (e) => {
          ...
          if (
            (e.classList.contains("jos_disabled") &&
              (e.classList.remove("jos_disabled"), e.classList.add("jos")),
            a && ("true" == a || /^\d+$/.test(a))
              ? e.setAttribute("data-jos_once", a)
              : e.setAttribute(
                  "data-jos_once",
              ...
              Array.from(e.children).forEach((c, u) => {
                if (!c.classList.contains("jos")) {
                  ...
                  if (e.dataset.jos_stagger_anchor || c.dataset.jos_anchor) {
                    let t =
                      "true" === e.dataset.jos_stagger_anchor
                        ? "#" + e.id
                        : e.dataset.jos_stagger_anchor;
                    c.setAttribute("data-jos_anchor", t);
                  }
                  c.setAttribute("data-jos_animation", f),
                    p && c.setAttribute("data-jos_animationinverse", p),
                    c.setAttribute("data-jos_duration", h);
                  ...
                  c.setAttribute("data-jos_delay", x),
                    ...
                    e.dataset.jos_stagger_scroll &&
                      c.setAttribute(
                        "data-jos_scroll",
                        e.dataset.jos_stagger_scroll
                      ),
                    e.dataset.jos_stagger_timingFunction &&
                      c.setAttribute(
                    ...
                    e.dataset.jos_stagger_invoke_out &&
                      c.setAttribute(
                        "data-jos_invoke_out",
                        e.dataset.jos_stagger_invoke_out
                      ),
          ...
          e.setAttribute("data-jos_animation", o),
            ...
            n &&
              (e.setAttribute("data-jos_duration", n),
              this.setRange.add(parseFloat(n))),
            l &&
              (e.setAttribute("data-jos_delay", l),
              this.setRange.add(parseFloat(l))),
            e.setAttribute("data-jos_counter", "0"),
            e.classList.add("jos-" + o),
            (e.dataset.jos_startvisible || this.default_startVisible) &&
              t.push(e),
          ...
          let c = [
              e.dataset.jos_rootmargin_top ||
                this.default_rootMargin.split(" ")[0],
              e.dataset.jos_rootmargin_right ||
                this.default_rootMargin.split(" ")[1],
              e.dataset.jos_rootmargin_bottom ||
                this.default_rootMargin.split(" ")[2],
              e.dataset.jos_rootmargin_left ||
          ...
          if (e.dataset.jos_anchor) {
            ...
            this.observers.push(t),
              t.observe(
                document.getElementById(e.dataset.jos_anchor.substring(1))
              );
          } else {
    ...
    animationUnset(t = 0) {
      -1 != t &&
        this.boxes?.forEach((s) => {
          s.classList.remove("jos"),
            s.classList.add("jos_disabled"),
            0 == t
              ? s.classList.add("jos-" + s.dataset.jos_animation)
              : s.classList.remove("jos-" + s.dataset.jos_animation);
        }),
    ...
    getStylesheet() {
      ...
      let e =
        ...
        this.default_delay +
        "s ;";
      for (let t of (s.insertRule(".jos {transition: " + e + ";}"),
      this.setRange))
        s.insertRule(
    ...
    start(t = 0) {
      return (
        -1 != t && (this.stop(), this.animationInit()),
        (this.disable = !1),
        "Started"
      );
    }
    ...
    destroy(t = 0) {
      for (let s in (this.animationUnset(-1),
      (this.boxes = void 0),
      (this.observers = []),
